    ...
    <div className="relative min-h-screen bg-background text-foreground overflow-x-hidden">
      ...
      <main className="relative z-10 pt-28 pb-24">
        <section className="mx-auto max-w-4xl px-4 py-12">
          ...
          >
            {/* Glow */}
            <div className="absolute top-0 left-1/2 -translate-x-1/2 sm:left-0 sm:translate-x-0 w-32 h-32 bg-violet-500/20 blur-[50px] -z-10 rounded-full" />
            
            <div className="inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-fuchsia-600 text-white shadow-glow mb-4">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-4 text-xs text-muted-foreground justify-center sm:justify-start">
              <span className="flex items-center gap-1.5 bg-secondary/50 border border-border px-3 py-1.5 rounded-full backdrop-blur-sm">
                <Calendar className="h-3.5 w-3.5 text-violet-400" /> Last Updated: May 26, 2026
              </span>
              <span className="flex items-center gap-1.5 bg-secondary/50 border border-border px-3 py-1.5 rounded-full backdrop-blur-sm">
                <ShieldAlert className="h-3.5 w-3.5 text-fuchsia-400" /> Service Agreement parameters
              </span>
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <h2 className="text-lg font-display font-bold text-foreground mb-3 flex items-center gap-2">
                <span className="text-violet-500 text-xs">01</span> Agreement to Terms
              </h2>
              <p>
            ...
            >
              <h2 className="text-lg font-display font-bold text-foreground mb-3 flex items-center gap-2">
                <span className="text-violet-500 text-xs">02</span> Development Services & Project Sprints
              </h2>
              <p>
            ...
            >
              <h2 className="text-lg font-display font-bold text-foreground mb-3 flex items-center gap-2">
                <span className="text-violet-500 text-xs">03</span> Intellectual Property Rights
              </h2>
              <p>
            ...
            >
              <h2 className="text-lg font-display font-bold text-foreground mb-3 flex items-center gap-2">
                <span className="text-violet-500 text-xs">04</span> Client Responsibilities & Data Inputs
              </h2>
              <p>
            ...
            >
              <h2 className="text-lg font-display font-bold text-foreground mb-3 flex items-center gap-2">
                <span className="text-violet-500 text-xs">05</span> Disclaimer of Warranties & Liability limits
              </h2>
              <p>
